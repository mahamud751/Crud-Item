...
export const filteredProducts = selector({
    ...
    get: ({ get }) => {
        ...
        const searchText = get(textSearchState)
        const itemFilter = get(itemFilterState)
        let filteredProducts = []
        filteredProducts = products.filter((product) => product.name.includes(searchText)).filter((product) => itemFilter === "" ? true : product.type === itemFilter)
...
export const countState = selector({
    key: "countState",
    get: ({ get }) => {
        let productCount = get(filteredProducts)
